package com.crm.newContactTest;
	...
	public class CreateContactAndCheckCancelBtn {
		@Test
		public void createContactAndCheckCancekBtn() throws EncryptedDocumentException, IOException {
			...
			//read from property file
					...
					boolean check = driver.findElement(By.xpath("//input[@title='Cancel [Alt+X]']")).isEnabled();
